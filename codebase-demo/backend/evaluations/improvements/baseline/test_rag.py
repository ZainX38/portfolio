...
class RagTests(unittest.TestCase):
    ...
    def test_grounded_references_come_from_retrieved_chunks(self):
        repository = indexed_repository()
        with patch("rag.model_digest", return_value="test-digest"), patch("rag.embed", return_value=[[1.0, 0.0]]), patch("rag.generate", return_value={"answer": "It returns hello.", "citations": ["chunk-1"]}):
